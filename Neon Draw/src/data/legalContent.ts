...
export const LEGAL_DOCS: Record<string, LegalDoc> = {
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          '4.1 Number Matrix: Each round utilizes exactly one hundred (100) distinct numbers, indexed from "00" through "99".',
          '4.2 Multiplier Allocation: In every round, exactly eighty (80) numbers are allocated Standard Multipliers ranging from 2x to 10x, and exactly twenty (20) numbers are allocated High Multipliers ranging from 11x to 20x.',
          ...
          '4.5 Single Winning Draw: At the conclusion of Phase 3, the server executes an authoritative cryptographic random draw selecting exactly one (1) winning number from 00 to 99.',
  ...
  about: {
    ...
    subtitle: 'The Next-Generation 100-Number Cyber Arena',
    version: '1.0',
    lastUpdated: 'February 2026',
    category: 'Platform',
    sections: [
      {
        ...
        content: [
          ...
          'Featuring a luminous cyberpunk aesthetic, the platform combines intuitive 100-number grid mechanics with dynamic multiplier distribution, provably fair server algorithms, and strict 60-second synchronized cycles.',
        ],
      },
      {
        id: 'architecture',
        ...
        content: [
          '• 100 Distinct Numbers: Every round features tiles from 00 to 99 in a clean matrix.',
          '• 80/20 Multiplier System: 80 numbers receive Standard Multipliers (2x–10x) and 20 numbers receive High Multipliers (11x–20x), with positions dynamically rotated every round.',
          '• 20-Number Selection Cap: Preserves strategic depth and healthy play by limiting each player to a maximum of 20 numbers per round.',
...
export const FAQ_DATA = [
  {
    ...
    a: 'NEON DRAW-99 is a fast-paced cyberpunk number game featuring a grid of 100 numbers (00 through 99). In each round, players select up to 20 numbers with assigned multipliers, followed by a cryptographically secured server draw that reveals a single winning number.',
  },
  {
    category: 'Gameplay',
  ...
  },
  {
    ...
    a: 'A player can select and place wagers on a MAXIMUM of 20 different numbers in any single round. The system strictly rejects attempts to pick a 21st number.',
  },
  {
    category: 'Gameplay',
  ...
  },
  {
    ...
    q: 'How are multipliers distributed across the 100 numbers?',
    a: 'Every round allocates multipliers across all 100 numbers: exactly 80 numbers receive Standard Multipliers (2x–10x), and exactly 20 numbers receive High Multipliers (11x–20x). The positions of the 20 High Multipliers change every round.',
  },
  {
    category: 'Multipliers',
    q: 'How is the winning payout calculated?',
    a: 'If the winning number matches your bet, your virtual payout is calculated as: (Bet Amount on Winning Number) × (Assigned Multiplier). For example, 100 Coins staked on #73 with a 15x multiplier yields 1,500 Virtual Coins.',
  },
  {
