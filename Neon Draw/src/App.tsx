    ...
    <div className="space-y-5 animate-in fade-in duration-150">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 pt-2">
        <div className="p-4 rounded-2xl bg-zinc-950/60 border border-white/5 backdrop-blur-sm flex items-center gap-3.5 shadow-lg">
          ...
          <div>
            <h4 className="text-xs font-extrabold text-white tracking-wide">100 Unique Numbers</h4>
            <p className="text-[11px] text-zinc-500 mt-0.5">80x (2x–10x) • 20x (11x–20x) multipliers</p>
          </div>
        </div>
