...
export class Database {
  ...
  private getDefaultConfig(): GameConfig {
    return {
      ...
      normalMultiplierCount: 80,
      highMultiplierCount: 20,
    ...
    return {
      ...
      promo_high_mult: {
        ...
        terms: [
          ...
          'Can be utilized across all 00-99 numbers',
        ],
  ...
  private loadInitialData(): DBData {
    if (fs.existsSync(this.dbFilePath)) {
      try {
        ...
        // Ensure config has all default properties
  ...
  public getRound(id: string): Round | null {
    return this.data.rounds[id] ? { ...this.data.rounds[id] } : null;
  }

  public getCurrentRoundId(): string | null {
    return this.data.currentRoundId;
  }
