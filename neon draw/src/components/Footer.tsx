        ...
        <div className="md:col-span-6 space-y-2">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-emerald-400 font-mono font-bold">20-Number Cyber Arena • Virtual Coins Demo</p>
            </div>
          </div>
          <p className="text-[11px] text-zinc-400 leading-relaxed max-w-lg">
            High-frequency mathematical simulation featuring 60-second server cycles, dynamic 2x–20x multipliers, and provably fair cryptographic RNG.
          </p>
        </div>
